...
class ValueTransformerTests: XCTestCase {
    ...
    func testDebugTransformComplex() {
        ...
        XCTAssertEqual(
            printer.string(),
            """
            Invoking transformer from test.swift:20 with CGRect(x: 1, y: 2, width: 3, height: 4).contains(CGRect(x: 1, y: 2, width: 3, height: 4))...
            Invoking transformer from test.swift:19 with CGRect(x: 1, y: 2, width: 3, height: 4).contains(CGRect(x: 1, y: 2, width: 3, height: 4))...
