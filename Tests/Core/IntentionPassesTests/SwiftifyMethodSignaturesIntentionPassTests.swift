...
extension SwiftifyMethodSignaturesIntentionPassTests {
    fileprivate func testThat(typeName: String = "T", sut: SwiftifyMethodSignaturesIntentionPass)
...
private class SwiftifyMethodSignaturesIntentionPassTestBuilder {
    ...
    class Asserter {
        ...
        func converts(
            toInitializer parameters: [ParameterSignature],
        ...
        func converts(
            to signature: FunctionSignature,
            file: StaticString = #filePath,
            line: UInt = #line
        ) {
