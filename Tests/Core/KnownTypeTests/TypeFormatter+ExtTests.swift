...
class TypeFormatter_ExtTests: XCTestCase {
    ...
    func testAsStringPropertyFromTypeWithTypeNameAndVarKeywordAndAccessors() {
        ...
        XCTAssertEqual(
            ...
            TypeFormatter.asString(
                property: type.knownProperties[0],
                ofType: type,
                withTypeName: true,
    ...
    func testAsStringKnownType() {
        let type = KnownTypeBuilder(typeName: "A", kind: .struct)
            ...
            .method(
                ...
                attributes: [
                    KnownAttribute(name: "_attribute", parameters: nil),
    ...
    func testLongAttributeProperty() {
        let type = KnownTypeBuilder(typeName: "A")
            ...
            .property(
                ...
                attributes: [
                    KnownAttribute(
                        name: "attributeWithVeryLongName",
                        parameters: nil
                    )
                ]
            )
            .property(
                ...
                type: "A",
                attributes: [
                    KnownAttribute(name: "attr1", parameters: nil),
