...
class UIKitCorrectorIntentionPassTests: XCTestCase {
    func testDrawRect() {
        let inputSignature = FunctionSignature(
            name: "drawRect",
            parameters: [
                .init(
                    label: nil,
        ...
        let expectedSignature = FunctionSignature(
            name: "draw",
            parameters: [
                .init(
                    label: nil,
        ...
        assert(
            sut: UIKitCorrectorIntentionPass(),
    ...
    func testUITableViewDelegate() {
        let inputSignature = FunctionSignature(name: "tableView", parameters: [
            .init(label: nil, name: "tableView", type: "UITableView"),
            .init(label: "willDisplayCell", name: "cell", type: "UITableViewCell"),
            .init(label: "forRowAtIndexPath", name: "indexPath", type: "IndexPath")
        ])
        let expectedSignature = FunctionSignature(name: "tableView", parameters: [
            .init(label: nil, name: "tableView", type: "UITableView"),
            .init(label: "willDisplay", name: "cell", type: "UITableViewCell"),
            .init(label: "forRowAt", name: "indexPath", type: "IndexPath")
        ])
    ...
    func testUITableViewDataSource() {
        let inputSignature = FunctionSignature(name: "tableView", parameters: [
            .init(label: nil, name: "tableView", type: "UITableView"),
            .init(label: "cellForRowAtIndexPath", name: "indexPath", type: "IndexPath"),
        ])
        let expectedSignature = FunctionSignature(name: "tableView", parameters: [
            .init(label: nil, name: "tableView", type: "UITableView"),
            .init(label: "cellForRowAt", name: "indexPath", type: "IndexPath")
        ])
...
extension UIKitCorrectorIntentionPassTests {
    fileprivate func assertSignature(
        _ intentions: IntentionCollection,
        ...
        if markAsOverride && !method.isOverride {
            XCTFail(
                "Expected to mark method \(format(result)) as override",
                file: file,
                line: line
            )
        }
