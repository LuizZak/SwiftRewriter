...
extension ObjcParserTests {
    ...
    static let __allTests__ObjcParserTests = [
        ("testCollectCommentsInMethodBody", testCollectCommentsInMethodBody),
        ("testCollectCommentsPrecedingCategoryImplementation", testCollectCommentsPrecedingCategoryImplementation),
        ("testCollectCommentsPrecedingCategoryInterface", testCollectCommentsPrecedingCategoryInterface),
        ("testCollectCommentsPrecedingClassImplementations", testCollectCommentsPrecedingClassImplementations),
        ("testCollectCommentsPrecedingClassInterface", testCollectCommentsPrecedingClassInterface),
        ("testCollectCommentsPrecedingEnumCase", testCollectCommentsPrecedingEnumCase),
        ("testCollectCommentsPrecedingEnumDeclaration", testCollectCommentsPrecedingEnumDeclaration),
        ("testCollectCommentsPrecedingFunction", testCollectCommentsPrecedingFunction),
        ("testCollectCommentsPrecedingGlobalVariable", testCollectCommentsPrecedingGlobalVariable),
        ("testCollectCommentsPrecedingInstanceVariable", testCollectCommentsPrecedingInstanceVariable),
        ("testCollectCommentsPrecedingMethodDeclaration", testCollectCommentsPrecedingMethodDeclaration),
        ("testCollectCommentsPrecedingMethodDefinition", testCollectCommentsPrecedingMethodDefinition),
        ("testCollectCommentsPrecedingPropertyDefinition", testCollectCommentsPrecedingPropertyDefinition),
        ("testCollectCommentsPrecedingProtocolDeclaration", testCollectCommentsPrecedingProtocolDeclaration),
        ("testCollectCommentsPrecedingTypedefNode", testCollectCommentsPrecedingTypedefNode),
        ("testCommentCollectionIgnoresMethodImplementationComments", testCommentCollectionIgnoresMethodImplementationComments),
        ("testCommentRangeInlinedMultiLineComment", testCommentRangeInlinedMultiLineComment),
        ("testCommentRanges", testCommentRanges),
