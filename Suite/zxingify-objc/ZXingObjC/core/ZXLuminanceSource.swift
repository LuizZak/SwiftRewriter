 ...
 */
@objc
class ZXLuminanceSource: NSObject {
    private var _width: CInt = 0
    private var _height: CInt = 0
    private var _cropSupported: Bool = false
    private var _rotateSupported: Bool = false
    /**
 ...
 */
    @objc var cropSupported: Bool {
        return self._cropSupported
    }
    /**
 * @return Whether this subclass supports counter-clockwise rotation.
 */
    @objc var rotateSupported: Bool {
        return self._rotateSupported
    }
    ...
    init(width: CInt, height: CInt) {
        if self = super.init() {
            ...
            _cropSupported = false

            _rotateSupported = false
        }
 ...
 */
    ...
    func crop(_ left: CInt, top: CInt, width: CInt, height: CInt) -> ZXLuminanceSource {
        /*
        @throw[NSExceptionexceptionWithName:NSInternalInconsistencyExceptionreason:@"This luminance source does not support cropping."userInfo:nil];
        */
    }
    /**
 ...
 */
    ...
    func rotateCounterClockwise() -> ZXLuminanceSource {
        /*
        @throw[NSExceptionexceptionWithName:NSInternalInconsistencyExceptionreason:@"This luminance source does not support rotation by 90 degrees."userInfo:nil];
        */
    }
    /**
 ...
 */
    ...
    func rotateCounterClockwise45() -> ZXLuminanceSource {
        /*
        @throw[NSExceptionexceptionWithName:NSInternalInconsistencyExceptionreason:@"This luminance source does not support rotation by 45 degrees."userInfo:nil];
        */
    }
    @objc
    func description() -> String? {
        var row = ZXByteArray(length: CUnsignedInt(self.width))
        ...
        while y < self.height {
            ...
            while x < self.width {
                ...
                let luminance: CInt = row.array[x] & 0xff
                var c: unichar
