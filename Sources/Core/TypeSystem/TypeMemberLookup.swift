...
class TypeMemberLookup {
    ...
    public func subscription(withParameterLabels labels: [String?],
        ...
        let result = _subscription(withParameterLabels: labels,
                                   invocationTypeHints: invocationTypeHints,
                                   static: isStatic,
                                   in: type)
        
        if memberSearchCache.usingCache {
            memberSearchCache.storeSubscript(withParameterLabels: labels,
                                             invocationTypeHints: invocationTypeHints,
                                             static: isStatic,
                                             in: type.typeName,
                                             subscript: result)
    ...
    private func _subscription(withParameterLabels labels: [String?],
                               invocationTypeHints: [SwiftType?]?,
                               static isStatic: Bool,
                               in type: KnownType) -> KnownSubscript? {
        ...
        let onSupertype =
            typeSystem.supertype(of: type)
                .flatMap {
                    subscription(withParameterLabels: labels,
                                 invocationTypeHints: invocationTypeHints,
                                 static: isStatic,
                                 in: $0)
                }
    ...
    public func subscription(withParameterLabels labels: [String?],
        ...
        return subscription(withParameterLabels: labels,
                            invocationTypeHints: invocationTypeHints,
                            static: isStatic, in: knownType)
    }
}
