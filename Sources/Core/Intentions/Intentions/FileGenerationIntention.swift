...
public final class FileGenerationIntention: Intention {
    public override var children: [Intention] {
        typeIntentions + typealiasIntentions + globalFunctionIntentions + globalVariableIntentions
    }
    ...
    public weak internal(set) var intentionCollection: IntentionCollection?
