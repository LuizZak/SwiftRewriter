...
public extension Asserter where Object == ObjcMethodDefinitionNode {
    /// Asserts that the underlying `ObjcMethodDefinitionNode` being tested has
    /// a return type node with a specified `type` value.
    ///
    ...
    /// Asserts that the underlying `ObjcMethodDefinitionNode` being tested has
    /// a specified `isClassMethod` value.
    ///
    /// Returns `nil` if the test failed, otherwise returns `self` for chaining
    /// further tests.
    @discardableResult
    ...
    /// Asserts that the underlying `ObjcMethodDefinitionNode` being tested has
    /// a specified `isOptionalMethod` value.
    ///
    /// Returns `nil` if the test failed, otherwise returns `self` for chaining
    /// further tests.
    @discardableResult
    ...
    /// Asserts that the underlying `ObjcMethodDefinitionNode` being tested has
    /// no function body associated with it.
    ///
    /// Returns `nil` if the test failed, otherwise returns `self` for chaining
    /// further tests.
    @discardableResult
