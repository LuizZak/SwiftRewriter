...
public extension Asserter where Object == PropertyDefinition {
    /// Asserts that the underlying `PropertyDefinition` being tested has a
    ...
    /// Asserts that the underlying `PropertyDefinition` being tested has a
    /// specified `isOptionalProperty` value.
    ///
    /// Returns `nil` if the test failed, otherwise returns `self` for chaining
    /// further tests.
    @discardableResult
    ...
    /// Asserts that the underlying `PropertyDefinition` being tested has a
    /// specified `hasIbOutletSpecifier` value.
    ///
    /// Returns `nil` if the test failed, otherwise returns `self` for chaining
    /// further tests.
    @discardableResult
    ...
    /// Asserts that the underlying `PropertyDefinition` being tested has a
    /// specified `hasIbInspectableSpecifier` value.
    ///
    /// Returns `nil` if the test failed, otherwise returns `self` for chaining
    /// further tests.
    @discardableResult
