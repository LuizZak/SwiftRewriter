...
public extension Asserter where Object == RawCodeComment {
    /// Asserts that the underlying `RawCodeComment` being tested has a
    ...
    func assert(
        ...
        asserter(forKeyPath: \.range, file: file, line: line) {
            $0.assert(equals: range.lowerBound..<range.upperBound, file: file, line: line)
        }
    }
