// Generated from /Users/luizfernandosilva/Documents/Projetos/objcgrammar/ObjectiveCLexer.g4 by ANTLR 4.9.1
import Antlr4
...
open class ObjectiveCLexer: Lexer {
	...
	static let AUTO=1, BREAK=2, CASE=3, CHAR=4, CONST=5, CONTINUE=6, DEFAULT=7, 
            ...
            PATH=186, DIRECTIVE_IMPORT=187, DIRECTIVE_INCLUDE=188, DIRECTIVE_PRAGMA=189, 
            DIRECTIVE_DEFINE=190, DIRECTIVE_DEFINED=191, DIRECTIVE_IF=192, 
            DIRECTIVE_ELIF=193, DIRECTIVE_ELSE=194, DIRECTIVE_UNDEF=195, 
            DIRECTIVE_IFDEF=196, DIRECTIVE_IFNDEF=197, DIRECTIVE_ENDIF=198, 
            DIRECTIVE_TRUE=199, DIRECTIVE_FALSE=200, DIRECTIVE_ERROR=201, 
            DIRECTIVE_WARNING=202, DIRECTIVE_HASINCLUDE=203, DIRECTIVE_BANG=204, 
            DIRECTIVE_LP=205, DIRECTIVE_RP=206, DIRECTIVE_EQUAL=207, DIRECTIVE_NOTEQUAL=208, 
            DIRECTIVE_AND=209, DIRECTIVE_OR=210, DIRECTIVE_LT=211, DIRECTIVE_GT=212, 
            DIRECTIVE_LE=213, DIRECTIVE_GE=214, DIRECTIVE_STRING=215, DIRECTIVE_ID=216, 
            DIRECTIVE_DECIMAL_LITERAL=217, DIRECTIVE_FLOAT=218, DIRECTIVE_NEWLINE=219, 
            DIRECTIVE_MULTI_COMMENT=220, DIRECTIVE_SINGLE_COMMENT=221, DIRECTIVE_BACKSLASH_NEWLINE=222, 
	...
	public
	static let STRING_MODE=1, PATH_MODE=2, DIRECTIVE_MODE=3, DEFINE=4, DIRECTIVE_TEXT_MODE=5, 
            DIRECTIVE_PATH_MODE=6
	public
	...
	static let ruleNames: [String] = [
		...
		"STRING_ESCAPE", "STRING_END", "STRING_VALUE", "PATH", "DIRECTIVE_IMPORT", 
		...
		"DIRECTIVE_PATH", "DIRECTIVE_PATH_STRING", "LetterOrDec", "Letter", "IntegerTypeSuffix", 
		"Exponent", "Dec", "FloatTypeSuffix", "PathFragment", "StringStart", "EscapeSequence", 
		"OctalEscape", "UnicodeEscape", "CUnicodeEscape", "HexDigit", "Ws", "A", 
