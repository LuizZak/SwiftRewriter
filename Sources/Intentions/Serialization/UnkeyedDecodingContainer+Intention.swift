public extension UnkeyedDecodingContainer {
    ...
    mutating func decodeIntention<I: Intention>(_ type: I.Type = I.self) throws -> I {
    ...
    mutating func decodeIntentionIfPresent<I: Intention>(_ type: I.Type = I.self) throws -> I? {
