    ...
    func createConversions() {
        ...
        addConversions(
            ...
            keywordPairs: [
                ...
                (["tableView", nil, "willDisplayHeaderView", "forSection"], ["tableView", nil, "willDisplayHeaderView", "forSection"]),
                (["tableView", nil, "willDisplayFooterView", "forSection"], ["tableView", nil, "willDisplayFooterView", "forSection"]),
                (["tableView", nil, "didEndDisplayingCell", "forRowAtIndexPath"], ["tableView", nil, "didEndDisplaying", "forRowAt"]),
                (["tableView", nil, "didEndDisplayingHeaderView", "forSection"], ["tableView", nil, "didEndDisplayingHeaderView", "forSection"]),
                (["tableView", nil, "didEndDisplayingFooterView", "forSection"], ["tableView", nil, "didEndDisplayingFooterView", "forSection"]),
                (["tableView", nil, "heightForRowAtIndexPath"], ["tableView", nil, "heightForRowAt"]),
                (["tableView", nil, "heightForHeaderInSection"], ["tableView", nil, "heightForHeaderInSection"]),
                (["tableView", nil, "heightForFooterInSection"], ["tableView", nil, "heightForFooterInSection"]),
                (["tableView", nil, "estimatedHeightForRowAtIndexPath"], ["tableView", nil, "estimatedHeightForRowAt"]),
                (["tableView", nil, "estimatedHeightForHeaderInSection"], ["tableView", nil, "estimatedHeightForHeaderInSection"]),
                (["tableView", nil, "estimatedHeightForFooterInSection"], ["tableView", nil, "estimatedHeightForFooterInSection"]),
                (["tableView", nil, "viewForHeaderInSection"], ["tableView", nil, "viewForHeaderInSection"]),
                (["tableView", nil, "viewForFooterInSection"], ["tableView", nil, "viewForFooterInSection"]),
